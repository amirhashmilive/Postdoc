/**
 * Dynamic Slide Numbering & Dropdown Jump System (assets/js/slide-number.js)
 * Auto-detects slides, parses page names, scrapes headings, and injects .sn-badge elements.
 */
(function SlideNumberSystem() {
    ...
    function init() {
        ...
        slides.forEach(function (slide, index) {
            ...
            badge.innerHTML = `<span class="sn-badge__label">Slide ${slideNum}/${slides.length}</span> <span class="sn-badge__caret">&#9662;</span>`;
